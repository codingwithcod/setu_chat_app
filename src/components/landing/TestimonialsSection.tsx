...
const testimonials = [
  ...
  },
  {
    ...
    quote: "Finally a chat app that feels premium. The dark mode and animations are chef's kiss. 🤌",
    avatar: "AC",
  ...
  },
  {
    name: "Emma Thompson",
    role: "Marketing Head",
    quote: "Emoji reactions, mentions, and pinned messages — everything we needed for our marketing team.",
    avatar: "ET",
