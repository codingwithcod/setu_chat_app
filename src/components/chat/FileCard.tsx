...
const FILE_ICONS: Record<string, { icon: typeof FileText; color: string }> = {
  ...
  "application/vnd.ms-excel": { icon: FileSpreadsheet, color: "text-green-400" },
  ...
  "application/zip": { icon: FileArchive, color: "text-amber-400" },
  "application/x-rar-compressed": { icon: FileArchive, color: "text-amber-400" },
  "application/vnd.rar": { icon: FileArchive, color: "text-amber-400" },
